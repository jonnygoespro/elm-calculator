...
var $author$project$Main$PlusButtonClicked = {$: 'PlusButtonClicked'};
...
var $author$project$Main$extractResult = function (result) {
	if (result.$ === 'Ok') {
		var value = result.a;
		return value;
	} else {
...
var $author$project$Main$handleOperator = F2(
	function (model, operator) {
		var _v0 = model.output;
		if (_v0.$ === 'Ok') {
			var currentOutput = _v0.a;
			return _Utils_update(
				model,
				{
					firstNumber: currentOutput,
					operator: operator,
					output: $elm$core$Result$Ok(0)
				});
		} else {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				case 'NumberButtonClicked':
					var newNumber = msg.a;
					var _v1 = model.output;
					if (_v1.$ === 'Ok') {
						var currentOutput = _v1.a;
						return (model.operator !== '=') ? _Utils_Tuple2(
							_Utils_update(
								model,
								{
									output: $author$project$Main$checkOverflow((currentOutput * 10) + newNumber)
								}),
							...
							_Utils_update(
								model,
								{
									firstNumber: 0,
									operator: '',
									output: $elm$core$Result$Ok(newNumber)
								}),
				...
				case 'MinusButtonClicked':
					return _Utils_Tuple2(
						A2($author$project$Main$handleOperator, model, '-'),
						$elm$core$Platform$Cmd$none);
				case 'MultiplyButtonClicked':
					return _Utils_Tuple2(
						A2($author$project$Main$handleOperator, model, '*'),
						$elm$core$Platform$Cmd$none);
				case 'DivideButtonClicked':
					return _Utils_Tuple2(
						A2($author$project$Main$handleOperator, model, '/'),
						$elm$core$Platform$Cmd$none);
					...
					if (_v3.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									firstNumber: $author$project$Main$extractResult(result),
									operator: '=',
									output: result
								}),
							$elm$core$Platform$Cmd$none);
				...
				default:
					...
					switch (key) {
						case '0':
							var $temp$msg = $author$project$Main$NumberButtonClicked(0),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '1':
							var $temp$msg = $author$project$Main$NumberButtonClicked(1),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '2':
							var $temp$msg = $author$project$Main$NumberButtonClicked(2),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '3':
							var $temp$msg = $author$project$Main$NumberButtonClicked(3),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '4':
							var $temp$msg = $author$project$Main$NumberButtonClicked(4),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '5':
							var $temp$msg = $author$project$Main$NumberButtonClicked(5),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '6':
							var $temp$msg = $author$project$Main$NumberButtonClicked(6),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '7':
							var $temp$msg = $author$project$Main$NumberButtonClicked(7),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '8':
							var $temp$msg = $author$project$Main$NumberButtonClicked(8),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '9':
							var $temp$msg = $author$project$Main$NumberButtonClicked(9),
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '+':
							var $temp$msg = $author$project$Main$PlusButtonClicked,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '-':
							var $temp$msg = $author$project$Main$MinusButtonClicked,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '*':
							var $temp$msg = $author$project$Main$MultiplyButtonClicked,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						case '/':
							var $temp$msg = $author$project$Main$DivideButtonClicked,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
...
var $author$project$Main$displayOutput = function (model) {
	var _v0 = model.output;
	if (_v0.$ === 'Ok') {
		var output = _v0.a;
		var _v1 = model.firstNumber;
		if (!_v1) {
			return $elm$core$String$fromInt(output);
		} else {
			var _v2 = model.operator;
			if (_v2 === '=') {
				return $elm$core$String$fromInt(output);
			} else {
				return $elm$core$String$fromInt(model.firstNumber) + (' ' + (model.operator + (' ' + $elm$core$String$fromInt(output))));
			}
		}
	} else {
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$displayOutput(model))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(8))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(9))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(4))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(5))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(6))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(1))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(2))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$NumberButtonClicked(3))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('actionButton'),
								$elm$html$Html$Events$onClick($author$project$Main$EqualSignButtonClicked)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('=')
